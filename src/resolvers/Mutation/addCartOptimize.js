...
/**
 * @name Mutation/addCartOptimize
 * @method
 * @memberof Cart/GraphQL
 * @summary resolver for the addCartOptimize GraphQL mutation
 ...
 */
export default async function addCartOptimize(
  parentResult,
  { input },
  context
) {
  ...
  const { cart, incorrectPriceFailures, minOrderQuantityFailures } =
    await context.mutations.addCartOptimize(context, {
      cartId,
      items,
      cartToken,
    });
